...
public class NumberProperty extends Setting {
    private final double min, max, increment;
    private double current;

    private ISliderCallBack iSlideSetting;

    public NumberProperty(String settingName, Module parentModule, double min, double max, double _default, double increment) {
    ...
    public NumberProperty(String settingName, Module parentModule, double min, double max, double _default, double increment, ISliderCallBack iSlideSetting) {
