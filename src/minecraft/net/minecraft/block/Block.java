...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity)
    {
        ...
        EventBoundingBox eventBoundingBox = new EventBoundingBox(getBlockState().getBlock(), pos, axisalignedbb);
        EventBus.INSTANCE.call(eventBoundingBox);
        axisalignedbb = eventBoundingBox.getBoundingBox();
        if (!eventBoundingBox.isCanceled() && axisalignedbb != null && mask.intersectsWith(axisalignedbb))
        {
