                    ...
                    case BLOCK:
                        ...
                        switch (animations.mode.getSelected().toUpperCase()) {
                            ...
                            case "SWANG":
                                ...
                                progress = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                GlStateManager.rotate(progress * 30.0F / 2.0F, -progress, -0.0F, 9.0F);
                                GlStateManager.rotate(progress * 40.0F, 1.0F, -progress / 2.0F, -0.0F);
                                this.func_178103_d();
                                break;
                            case "SWANK":
                                GL11.glTranslated(-0.1D, 0.15D, 0.0D);
                                this.transformFirstPersonItem(f / 2.0F, f1);
                                progress = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                GlStateManager.rotate(progress * 30.0F, -progress, -0.0F, 9.0F);
                                GlStateManager.rotate(progress * 40.0F, 1.0F, -progress, -0.0F);
                                this.func_178103_d();
                                break;
                            case "SWING":
                                GL11.glTranslated(-0.1D, 0.15D, 0.0D);
                            ...
                            case "SWONG":
                                ...
                                progress = MathHelper.sin(f1 * f1 * 3.1415927F);
                                GlStateManager.rotate(-progress * 40.0F / 2.0F, progress / 2.0F, -0.0F, 9.0F);
                                GlStateManager.rotate(-progress * 30.0F, 1.0F, progress / 2.0F, -0.0F);
                                this.func_178103_d();
                                break;
                            case "SWAING":
                                GL11.glTranslated(-0.1D, 0.15D, 0.0D);
