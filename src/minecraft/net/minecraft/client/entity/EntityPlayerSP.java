...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
            EventBus.INSTANCE.call(new EventUpdate());
            super.onUpdate();
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        EventBus.INSTANCE.call(eventMove);
        if(eventMove.isCanceled()) return;
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        boolean ground = e.isGround(), flag = e.isSprint(), flag1 = e.isSneaking();
    ...
    public void onLivingUpdate()
    {
        ...
        {
            EventSlow eventSlow = new EventSlow(0.2f, 0.2f);
            EventBus.INSTANCE.call(eventSlow);
            this.movementInput.moveStrafe *= eventSlow.getMoveStrafing();
            this.movementInput.moveForward *= eventSlow.getMoveForward();
