    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                StringBuilder passLike = new StringBuilder();
                while(passLike.length() < s1.length())
                    passLike.append("*");
                j1 = this.fontRendererInstance.drawStringWithShadow(passLike.toString(), (float)l, (float)i1, i);
            }
