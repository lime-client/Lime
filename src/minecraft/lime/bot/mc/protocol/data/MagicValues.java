...
import lime.bot.mc.protocol.data.game.BossBarAction;
import lime.bot.mc.protocol.data.game.BossBarColor;
import lime.bot.mc.protocol.data.game.BossBarDivision;
...
import lime.bot.mc.protocol.data.game.TitleAction;
import lime.bot.mc.protocol.data.game.UnlockRecipesAction;
import lime.bot.mc.protocol.data.game.advancement.Advancement;
import lime.bot.mc.protocol.data.game.entity.Effect;
import lime.bot.mc.protocol.data.game.entity.EntityStatus;
import lime.bot.mc.protocol.data.game.entity.EquipmentSlot;
import lime.bot.mc.protocol.data.game.entity.attribute.AttributeType;
import lime.bot.mc.protocol.data.game.entity.attribute.ModifierOperation;
import lime.bot.mc.protocol.data.game.entity.attribute.ModifierType;
import lime.bot.mc.protocol.data.game.entity.metadata.MetadataType;
import lime.bot.mc.protocol.data.game.entity.player.Animation;
import lime.bot.mc.protocol.data.game.entity.player.BlockBreakStage;
import lime.bot.mc.protocol.data.game.entity.player.CombatState;
import lime.bot.mc.protocol.data.game.entity.player.GameMode;
import lime.bot.mc.protocol.data.game.entity.player.Hand;
import lime.bot.mc.protocol.data.game.entity.player.InteractAction;
import lime.bot.mc.protocol.data.game.entity.player.PlayerAction;
import lime.bot.mc.protocol.data.game.entity.player.PlayerState;
import lime.bot.mc.protocol.data.game.entity.player.PositionElement;
import lime.bot.mc.protocol.data.game.entity.type.GlobalEntityType;
import lime.bot.mc.protocol.data.game.entity.type.MobType;
import lime.bot.mc.protocol.data.game.entity.type.PaintingType;
import lime.bot.mc.protocol.data.game.entity.type.object.HangingDirection;
import lime.bot.mc.protocol.data.game.entity.type.object.MinecartType;
import lime.bot.mc.protocol.data.game.entity.type.object.ObjectType;
import lime.bot.mc.protocol.data.game.scoreboard.CollisionRule;
import lime.bot.mc.protocol.data.game.scoreboard.NameTagVisibility;
import lime.bot.mc.protocol.data.game.scoreboard.ObjectiveAction;
import lime.bot.mc.protocol.data.game.scoreboard.ScoreType;
import lime.bot.mc.protocol.data.game.scoreboard.ScoreboardAction;
import lime.bot.mc.protocol.data.game.scoreboard.ScoreboardPosition;
import lime.bot.mc.protocol.data.game.scoreboard.TeamAction;
import lime.bot.mc.protocol.data.game.scoreboard.TeamColor;
import lime.bot.mc.protocol.data.game.setting.ChatVisibility;
import lime.bot.mc.protocol.data.game.setting.Difficulty;
import lime.bot.mc.protocol.data.game.statistic.GenericStatistic;
import lime.bot.mc.protocol.data.game.window.AdvancementTabAction;
import lime.bot.mc.protocol.data.game.window.ClickItemParam;
import lime.bot.mc.protocol.data.game.window.CraftingBookDataType;
import lime.bot.mc.protocol.data.game.window.CreativeGrabParam;
import lime.bot.mc.protocol.data.game.window.DropItemParam;
import lime.bot.mc.protocol.data.game.window.FillStackParam;
import lime.bot.mc.protocol.data.game.window.MoveToHotbarParam;
import lime.bot.mc.protocol.data.game.window.ShiftClickItemParam;
import lime.bot.mc.protocol.data.game.window.SpreadItemParam;
import lime.bot.mc.protocol.data.game.window.WindowAction;
import lime.bot.mc.protocol.data.game.window.WindowType;
import lime.bot.mc.protocol.data.game.window.property.AnvilProperty;
import lime.bot.mc.protocol.data.game.window.property.BrewingStandProperty;
import lime.bot.mc.protocol.data.game.window.property.EnchantmentTableProperty;
import lime.bot.mc.protocol.data.game.window.property.FurnaceProperty;
import lime.bot.mc.protocol.data.game.world.Particle;
import lime.bot.mc.protocol.data.game.world.WorldBorderAction;
import lime.bot.mc.protocol.data.game.world.WorldType;
import lime.bot.mc.protocol.data.game.world.block.BlockFace;
import lime.bot.mc.protocol.data.game.world.block.UpdatedTileType;
import lime.bot.mc.protocol.data.game.world.block.value.ChestValueType;
import lime.bot.mc.protocol.data.game.world.block.value.GenericBlockValueType;
import lime.bot.mc.protocol.data.game.world.block.value.MobSpawnerValueType;
import lime.bot.mc.protocol.data.game.world.block.value.NoteBlockValueType;
import lime.bot.mc.protocol.data.game.world.block.value.PistonValue;
import lime.bot.mc.protocol.data.game.world.block.value.PistonValueType;
import lime.bot.mc.protocol.data.game.world.effect.ParticleEffect;
import lime.bot.mc.protocol.data.game.world.effect.SmokeEffectData;
import lime.bot.mc.protocol.data.game.world.effect.SoundEffect;
import lime.bot.mc.protocol.data.game.world.map.MapIconType;
import lime.bot.mc.protocol.data.game.world.notify.ClientNotification;
import lime.bot.mc.protocol.data.game.world.notify.DemoMessageValue;
import lime.bot.mc.protocol.data.game.world.notify.EnterCreditsValue;
import lime.bot.mc.protocol.data.game.world.sound.BuiltinSound;
import lime.bot.mc.protocol.data.game.world.sound.SoundCategory;
import lime.bot.mc.protocol.data.handshake.HandshakeIntent;
