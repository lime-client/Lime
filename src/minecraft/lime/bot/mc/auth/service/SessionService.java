package lime.bot.mc.auth.service;

import lime.bot.mc.auth.data.GameProfile;
import lime.bot.mc.auth.exception.profile.ProfileException;
import lime.bot.mc.auth.exception.profile.ProfileLookupException;
import lime.bot.mc.auth.exception.profile.ProfileNotFoundException;
import lime.bot.mc.auth.exception.property.ProfileTextureException;
import lime.bot.mc.auth.exception.property.PropertyException;
import lime.bot.mc.auth.exception.request.RequestException;
import lime.bot.mc.auth.util.Base64;
import lime.bot.mc.auth.util.HTTP;
import lime.bot.mc.auth.util.UUIDSerializer;
