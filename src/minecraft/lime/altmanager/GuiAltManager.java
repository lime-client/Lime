...
extends GuiScreen {
    ...
    public TheAlteningAuthentication serviceSwitcher = TheAlteningAuthentication.mojang();
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                ...
                AltManager altManager = Lime.altManager;
    ...
    public void drawScreen(int par1, int par2, float par3) {
        Lime.altManager.theAlteningAuthentication = serviceSwitcher;
        if (Mouse.hasWheel()) {
        ...
        GL11.glEnable(3089);
        int y2 = 38;
        AltManager altManager2 = Lime.altManager;
        for (Alt alt2 : AltManager.registry) {
            ...
            if (alt2 == this.selectedAlt) {
                ...
                Gui.drawRect(52, (double) y2 - this.offset - 4, width - 52, y2 - this.offset + 20, 1);
            } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
